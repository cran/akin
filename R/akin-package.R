...
#' list environments, sparse matrices, C++ combinatorial methods, and background processing in few places.
#'
#' Nevertheless, Users could try thread optimization, memoisation or parallel processing, as these techniques were
#' outside the scope.
#'
...
#' such as, one-hot encoding and scoring - stratified, proportional, random or probabilistic data sampling, data normalization
#' and thresholding, substring location inside strings e.g. peptides inside protein chains, common substrings identification
...
#' in the R console. When possible, suppression of messages should be avoided.
#'
#' @keywords internal
