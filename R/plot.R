...
plotish = substitute(expr = {
                   ...
                   plot(xa, a, xaxt = 'n', yaxt = 'n', type = 'b', pch = 20, xlab = 'Characters', ylab = ''
                   ...
                   axis(2, at = seq(min(a), max(a), by = 5e+5), , cex.axis = 0.7, yaxs = 'i', las = 1
                        , ylim = c(min(a), max(a)*1.05), labels = format(seq(min(a), max(a), by = 5e+5)
