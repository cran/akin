...
#' @keywords internal
#'
#' @seealso \link{akin-deprecated}, \link[RcppAlgos]{comboIter}, \link[RcppAlgos]{comboGeneral}, \link[RcppAlgos]{comboCount}
#'
#' @keywords Proteomics
#'
#' @export
...
common = function(X, Y = NULL, from, to, lower = NULL, upper = NULL, outlist = FALSE, rows = 1000, wait = 100, ...) {
           ####################################################################################################
            ...
            .Deprecated(new = 'fcommon', msg = 'Deprecated as of v.0.3.2 and replaced by fcommon()!')
